...
#TODO: this whole file needs to be audited twice
...
module Mysql2BinlogStream
  ...
  class BinlogEventParser
    ...
    # https://github.com/noplay/python-mysql-replication/blob/master/pymysqlreplication/event.py#L157
    # https://github.com/krowinski/php-mysql-replication/blob/master/src/MySQLReplication/Event/QueryEvent.php#L11
    ...
    def table_map_event(header)
      ...
      #TODO: table skip / db skip filter here!?? Yeh !!

      columns = parser.read_varint
      og_col = parser.read_uint8_array(columns)

      columns_type = og_col.map { |c| MYSQL_TYPES[c] || "unknown_#{c}".to_sym }

      # https://github.com/krowinski/php-mysql-replication/blob/41073226e6c35c793499ba928ae02d81f1a47b8a/src/MySQLReplication/Event/RowEvent/ColumnDTO.php#L48
